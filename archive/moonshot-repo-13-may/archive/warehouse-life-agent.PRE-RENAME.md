...
- This agent must not be present in any shipped homepage variant of the deliverable. It exists only in `moonshot-prototype.html`. Any future shipped homepage must remain free of sim engine code.
